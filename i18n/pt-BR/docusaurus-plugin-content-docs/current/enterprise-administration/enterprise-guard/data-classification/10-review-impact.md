...
![Seção de distribuição de níveis de classificação recolhível](images/24937187682962_Collapsible_Distribution_of_classification.png)
...
![Interface de usuário baseada em colunas exibindo o número de boards adicionadas, o número de boards removidas e o total atualizado para cada nível de classificação](images/24937187686546_columnview.png)
...
![Recurso de detalhamento com visualizar abrangente das atualizações](images/24937187688082_drilldown_feature_classification.png)
...
*![Configurar classificação Revisar impacto](images/24937187690386_guardrails.png)
Figura 4: Configurar classificação > Revisar impacto*

## Atualizar a configuração de classificação automática
