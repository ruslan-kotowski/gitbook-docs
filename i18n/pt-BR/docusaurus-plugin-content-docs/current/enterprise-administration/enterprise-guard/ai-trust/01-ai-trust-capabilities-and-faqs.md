---
title: "Funcionalidades de Confian\xE7a em IA e Perguntas Frequentes"
...
- Controles administrativos granulares do Miro AI: definir acesso ao nível de funcionalidade (Todos/Ninguém/Times específicos) dentro de cada categoria de funcionalidade.
- [Bloquear uso do Miro AI com Proteções Inteligentes](#h_block_ai_with_guardrails): usar Proteções Inteligentes para bloquear todas as interações baseadas em IA na Miro quando for necessário proteger dados sensíveis ou classificados.
- [Painel de Visão Geral de Análise Administrativa](#h_admin_analytics_overview): rastrear boards, usuários, times, licenças e templates com tendências históricas e atualização diária.
- Moderação de IA (também disponível na versão Enterprise): defina níveis de filtro em toda a organização (Restrito, Padrão, Mínimo) para avaliar prompts que possam gerar resultados prejudiciais ou inadequados.
- Bloqueio de prompts: bloqueie prompts que contêm dados confidenciais ou código-fonte no momento da submissão; exiba uma mensagem de política em vez de enviá-los para um LLM.
- Enterprise Guard e Microsoft Purview DSPM para integração com IA: encaminhe prompts e respostas para o Purview para monitoramento centralizado, auditoria e governança.

## Controles de admin granulares para o complemento Enterprise Guard

Os controles de admin da Miro AI permitem que os Admins da empresa no plano Enterprise decidam quais funcionalidades de IA estão disponíveis em sua organização e gerenciem quem pode usá-las. Os admins também podem visualizar os modelos que impulsionam cada funcionalidade de IA. Com o complemento Enterprise Guard, os controles da Miro AI se estendem ao nível de funcionalidade dentro de cada categoria de funcionalidades, o que ajuda a priorizá-las com base nas necessidades organizacionais e nos requisitos de segurança. Além da categoria completa de funcionalidades da Miro AI, os admins podem também habilitar, restringir ou remover funcionalidades específicas da Miro AI. Por exemplo, dentro da categoria Imagens, você pode ativar Criar imagens com IA e desabilitar Remover fundo. Use esses controles para implementar a IA com segurança e atender aos requisitos de segurança enquanto promove a adoção das funcionalidades de IA. Para mais informações, consulte a [documentação sobre controles granulares de admin da Miro AI](../../enterprise-guard/ai-trust/02-miro-ai-granular-admin-controls.md).

**Propósito e escopo**

**O que é controle granular para Miro AI?**

Com o complemento Enterprise Guard, Admins da empresa podem ativar, restringir ou remover o acesso a funcionalidades individuais de IA dentro de cada categoria de funcionalidades. Isso permite escolher exatamente quais funcionalidades os times podem usar.
...
- **Nível de funcionalidade:** Todos, Ninguém ou Times específicos se aplica a toda a categoria. Se você desativar uma funcionalidade, os usuários perdem o acesso a essa funcionalidade e a todas as suas funcionalidades em todos os boards. Se desativar todas as funcionalidades, Crie com IA aparecerá desabilitado no board.
- **Nível de funcionalidade:** Com o Enterprise Guard, você pode definir Todos, Ninguém ou Times específicos por funcionalidade individual. Desativar uma funcionalidade remove o acesso apenas a essa funcionalidade; outras funcionalidades na mesma funcionalidade permanecem disponíveis se ativadas.
...
**O que acontece quando desativo uma funcionalidade individual?**
...
## Bloquear uso do Miro IA com Proteções Inteligentes

Use as Proteções Inteligentes para bloquear todas as interações alimentadas por IA na Miro quando precisar proteger dados sensíveis ou confidenciais. Quando essa proteção for aplicada, todas as ferramentas do Miro AI são desabilitadas nos boards afetados, enquanto a colaboração sem IA permanece disponível. Para referências e configuração, consulte a visão geral de Proteções Inteligentes e Definir proteções.

**Propósito e escopo**

**O que faz a opção "Bloquear uso do Miro AI"?**

Ela desabilita todas as funcionalidades de Miro AI (por exemplo, geração de texto, geração/reconhecimento de imagens, sugestões inteligentes) sempre que este guardrail se aplica, prevenindo qualquer interação com conteúdo sensível ou classificado via IA.

**O que permanece disponível para os usuários?**

Os usuários podem continuar a colaboração regular, sem o uso de IA. Conteúdos já gerados por IA permanecem nos boards e podem ser visualizados, movidos ou editados manualmente — mas os usuários não podem usar Miro AI para modificá-los ou regenerá-los.

**Acesso e pré-requisitos**

**Quem pode configurar esta proteção e onde?**

Admins de Conteúdo Sensível configuram as proteções no *Enterprise Guard* em Classificação de Dados → Proteções. (Admins da Empresa atribuem a função de Admin de Conteúdo Sensível.)

**O que é necessário antes de atribuir esta proteção?**

Defina seus níveis de classificação e (opcionalmente) a auto classificação para que a proteção possa ser aplicada por classificação (por exemplo, INTERNO, CONFIDENCIAL).

**Comportamento e impacto**

**Quem é afetado quando a barreira é aplicada?**

Todos — incluindo titulares e cotitulares de board — não podem acessar ou invocar a Miro AI nos boards afetados.

**Ela remove conteúdo de IA existente?**

Não. Ela impede interações futuras com IA; o conteúdo de IA existente permanece disponível para visualização e edições manuais.

**Quando as alterações entram em vigor?**

Após você publicar suas atualizações de barreira, a aplicação é imediata nos boards afetados.
...
3. Marque a caixa **Bloquear uso do Miro AI** e clique em **Concluído**.
4. Clique em **Avançar** e revise o impacto, depois clique em **Publicar** para aplicar.

**Devo usar o modo Padrão ou Estrito?**

No modo Padrão, as proteções não irão substituir as configurações de compartilhamento existentes. No modo Rígido, as proteções substituem o compartilhamento ativo e aplicam os controles mais rígidos. Escolha com base nas suas necessidades de gestão de mudanças.

**Experiência do usuário**

**O que os usuários verão nos boards onde a IA está bloqueada?**

Os pontos de entrada da Miro IA aparecem desabilitados ou indisponíveis, e os usuários não podem invocar ferramentas de IA no canvas ou nos menus desses boards.
...
**Como isso se relaciona com os controles granulares de admin da Miro AI?**

Os controles granulares gerenciam quem pode usar funcionalidades específicas de IA. O guardrail é uma camada de política: quando ativo, ele bloqueia a IA independentemente das configurações de funcionalidade.

**Como isso difere do bloqueio de prompts ou da moderação de IA?**

- **Bloqueio de prompt** impede a submissão de prompts sensíveis; a IA permanece disponível para prompts não sensíveis.
- **Moderação de IA** filtra conteúdos prejudiciais ou inadequados.
- **Bloquear uso da Miro AI** desabilita totalmente a IA nos boards afetados.

**Solução de problemas**

**O IA ainda aparece em alguns boards. O que devo verificar?**

- Confirme se a classificação do board é uma em que a proteção está ativada e se você clicou em **Publicar** após editar as proteções.
- Se estiver usando auto-classificação, verifique se a classificação do board foi atualizada com base no conteúdo atual.
- Nos modos Estrito vs Padrão, assegure que suas expectativas correspondem ao modo de implantação selecionado.

**Precisamos reativar o IA para um subconjunto de trabalho.**

Ajuste a proteção para a classificação relevante ou reclassifique os boards que devem permitir IA, e então publique a atualização.
...
- **Boards:** Boards únicos abertos desde o início do período selecionado. Inclui boards que posteriormente foram movidos para a Lixeira.
...
Sim. Os totais de Boards e Times excluem itens que estejam atualmente na Lixeira. Contagens históricas de "ativos" podem incluir itens que posteriormente foram movidos para a Lixeira.

**O que mostra o gráfico de Licenças?**
...
**Como os valores históricos são exibidos nos gráficos de Visão Geral?**

Widgets históricos mostram valores no último dia de cada período. Até um ano de histórico está disponível ou até onde os dados existirem.

**Atualização de dados e controles**

**Com que frequência os dados de Visão Geral são atualizados e onde posso ver isso?**

Pelo menos uma vez a cada 24 horas. Um carimbo de data/hora "Última atualização" está disponível no painel.

**Como posso alterar o intervalo de tempo?**

Use o seletor de intervalo de tempo no canto superior direito da página de Análise.

## Moderação com Miro AI
...
Admins da empresa no plano Enterprise com o Enterprise Guard podem configurar a definição nas Configurações da organização.
...
Acesse Configurações → Miro AI → Moderação, escolha Restrito/Padrão/Mínimo e depois clique em **Salvar alterações**. A aplicação é imediata em toda a organização.

**Níveis e comportamento**

**O que os níveis significam?**

- **Restrito:** Bloqueia conteúdo Padrão + de risco baixo a moderado (por exemplo, ódio sutil/codificado, conteúdo sexual sugestivo, violência não gráfica, menções não explícitas de autoagressão).
...
- **Controles granulares de administração:** Alternativas de funcionalidade governam quem pode acessar as funcionalidades de IA quando a IA está disponível.
...
Varredura de código bloqueia prompts que contêm código fonte reconhecível; por design, é necessário um bloco mínimo de código (por exemplo, 5+ linhas) para acionar. Ative ou desative na configuração de Bloqueio de prompt.
...
No momento, prompts e respostas baseados em texto em todas as funcionalidades da Miro AI são encaminhados. Conteúdos de imagem não são encaminhados.
...
Normalmente de 10 a 30 minutos após a ação de IA na Miro. Veja no Microsoft Purview → DSPM para IA → Explorar atividades, ou verifique os logs de auditoria.

**Existem limitações notáveis?**

Por enquanto, apenas um inquilino Entra pode ser configurado por vez. Em ambientes com múltiplos IdP ou múltiplos inquilinos, apenas usuários autenticando via o inquilino configurado são registrados. Imagens não estão incluídas.
...
- **Miro:** Plano Enterprise com Enterprise Guard, função de Admin da empresa, Entra ID configurado para logon único. Para habilitar essa funcionalidade, entre em contato com seu Gerente de Sucesso do Cliente.
...
**Como verifico se a configuração está funcionando?**
...
**Como posso desconectar ou trocar de locatários?**

Na Miro: Integrações Enterprise → Microsoft Purview para IA → Desconectar. Para trocar de locatários, desconecte primeiro e depois reconecte usando o novo ID de locatário.
...
Use as ferramentas de exportação do Microsoft Purview. A Miro encaminha a atividade para o seu inquilino Microsoft, onde suas políticas são aplicadas.
...
Confirme que o Enterprise Guard está ativado e que você tem acesso às integrações do Enterprise. Verifique se o ID do tenant corresponde exatamente ao seu tenant de logon único da Miro. Certifique-se de que uma ação de teste de IA foi realizada por um usuário autenticando-se através desse tenant. Verifique a licença e os filtros do Purview. Permita até 30 minutos para a ingestão.
