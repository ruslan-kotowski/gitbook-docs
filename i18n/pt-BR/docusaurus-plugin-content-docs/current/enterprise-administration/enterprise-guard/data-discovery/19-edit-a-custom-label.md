---
title: Editar etiqueta personalizada
...
:::note
Recomendamos editar as etiquetas somente antes de associá-las a um nível de classificação.
:::

Edite as etiquetas para atualizar as condições, como palavras-chave ou widgets, que você deseja identificar e localizar nos boards da Miro. Para editar uma etiqueta, siga estes passos:

:::note
Para editar etiquetas personalizadas, você deve ter a [função de admin de conteúdo sensível](../../enterprise-subscription-management/enterprise-guard-overview/03-understand-admin-roles-and-their-privileges.md). Para solicitar a função de admin de conteúdo sensível, entre em contato com seu Admin da empresa.
:::
...
3. Na página **Visão geral** da **Descoberta de dados**, clique na elipse (três pontos) na linha da etiqueta que deseja editar e, em seguida, clique em **Editar etiqueta**.
4. Na página **Editar etiqueta personalizada**, edite os detalhes da etiqueta.
   ...
   | **Nome abreviado** | **Tamanho máximo:** 10 caracteres, alfanumérico  Versão abreviada do nome da etiqueta. O nome abreviado é usado para se referir a esta etiqueta personalizada na descoberta de dados e no buscador de conteúdo. **Nota:** O nome abreviado não fica visível nos logs de auditoria. Se você quiser pesquisar ou visualizar os logs de auditoria associados a esta etiqueta, pode usar o ID da etiqueta. |
