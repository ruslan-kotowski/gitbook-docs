...
![Repliable Répartition de la section des niveaux de classification](images/24937188020370_Collapsible_Distribution_of_classification.png)
...
![Interface utilisateur à colonnes affichant le nombre de tableaux ajoutés, le nombre de tableaux retirés et le total actualisé pour chaque niveau de classification.](images/24937163383442_columnview.png)
...
![Fonction d'exploration avec vue d'ensemble des mises à jour](images/24937163386642_drilldown_feature_classification.png)
...
*![Configurer la classification Examiner l'impact](images/24937163389330_guardrails.png)
Figure 4 : Configurer la classification > Examiner l'impact*

## Mettre à jour la configuration de la classification automatique
