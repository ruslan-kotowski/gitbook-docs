---
title: Configurar la gestión de movilidad de Enterprise (EMM) en iOS
...
Para la mayoría, habilitar la configuración de EMM requerirá agregar Miro al catálogo de aplicaciones de tu organización. Este proceso puede diferir de un proveedor de EMM a otro. Aun así, por lo general, agregarás Miro al catálogo de aplicaciones directamente desde Apple Store y establecerás una política de distribución basada en los grupos de dispositivos, grupos de usuarios, etc.
...
1. Ve a **Aplicaciones > Catálogo de Aplicaciones** y haz clic en **Añadir.**
2. Selecciona "**tienda iOS**" y tu país como origen.
3. Busca "**Miro**" y selecciona "**Miro: Pizarra online**" de la lista de aplicaciones disponibles.
4. Establece la configuración y las políticas de distribución según las preferencias de tu organización.

Intune (Microsoft Endpoint Manager)

[Puedes encontrar la guía general de implementación de Intune de MS](https://learn.microsoft.com/mem/intune/fundamentals/deployment-guide-platform-ios-ipados) aquí.

1. Ve a **Aplicaciones > iOS/iPadOS** y haz clic en **Añadir**.
2. Selecciona **App de la tienda > Tienda de aplicaciones de iOS** como el **tipo de aplicación**.
3. Haz clic en **Buscar en la App Store**.
4. Selecciona el país de la tienda que prefieres usar.
5. Busca "**Miro**" y selecciona "**Miro: Pizarra online**" de la lista de aplicaciones disponibles.
6. Establece la configuración y las políticas de distribución según las preferencias de tu organización.

### Completar previamente la configuración de la aplicación

Miro usa AppConfig como la forma unificada de configurar y proteger los datos de los clientes. Muchas soluciones de EMM admiten el formato AppConfig o lo aceptan en un “modo de compatibilidad”. Para conocer las limitaciones exactas aplicables en tu caso, consulta la documentación de tu proveedor de EMM.
...
1. 1. Ve a **Aplicaciones > Catálogo de aplicaciones**.
   2. Navega hasta "**Miro: Pizarra online**" ajustes.
   3. Ve a **Configuraciones de aplicaciones > Configuración de aplicación gestionada de Apple**.
   4. Haz clic en **Añadir** para crear un nuevo perfil de distribución.
   5. Define el nombre de tu perfil de configuración.
   6. Define la **Configuración de aplicaciones administradas de Apple**.
   7. Selecciona el perfil de distribución en la sección **Distribuir esta configuración de aplicación**.

Intune (Microsoft Endpoint Manager)

[Puedes encontrar la guía general de implementación de Intune de MS](https://learn.microsoft.com/mem/intune/fundamentals/deployment-guide-platform-ios-ipados) aquí.

1. 1. Ve a **Aplicaciones > Políticas de configuración de aplicaciones**.
   2. Haz clic en **Añadir > Dispositivo administrador** para crear una nueva configuración de aplicación.
   3. Define el nombre de tu perfil de configuración.
   4. Selecciona **iOS/iPadOS** como **Plataforma**.
   5. Selecciona **Miro: Pizarra online** como **app de Destino** haciendo clic en **Seleccionar app**.
   6. Selecciona **Usar configuración de diseñador** como **Formato de configuración de ajustes**.
   7. Definir la configuración de la aplicación.
   8. Selecciona el perfil de distribución para la configuración.
...
| **AppleID** miro.authentication.appleIdRestricted | verdadero/falso *Sólo disponible en dispositivos Apple |
