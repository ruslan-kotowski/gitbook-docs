...
![Sección colapsable Distribución de los niveles de clasificación](images/24937321086482_Collapsible_Distribution_of_classification.png)
...
![Interfaz de usuario basada en columnas que muestra el número de tableros añadidos, el número de tableros eliminados y el total actualizado para cada nivel de clasificación.](images/24937321087378_columnview.png)
...
![Función de desglose con una visión completa de las actualizaciones](images/24937321088658_drilldown_feature_classification.png)
...
*![Configurar la clasificación Revisar el impacto](images/24937329103890_guardrails.png)
Figura 4: Configurar la clasificación > Revisar el impacto*

## Actualiza la configuración de las barreras de protección
