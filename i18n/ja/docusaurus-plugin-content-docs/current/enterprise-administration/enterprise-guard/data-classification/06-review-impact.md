...
![折りたたみ式機密分類レベル分布セクション](images/24937321458066_Collapsible_Distribution_of_classification.png)
...
![追加されたボード数、削除されたボード数、機密分類レベルごとの更新合計を表示するカラムベースのユーザーインターフェース](images/24937321465234_columnview.png)
...
![更新情報を包括的に表示するドリルダウン機能](images/24937329465618_drilldown_feature_classification.png)
...
*![機密分類の設定 影響の確認](images/24937329471378_guardrails.png)
図 4：機密分類の設定 > 影響の確認*
