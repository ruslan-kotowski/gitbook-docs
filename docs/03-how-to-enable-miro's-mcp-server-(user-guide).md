...
> For Enterprise accounts, enabling MCP requires admin approval. If you're in an Enterprise team, refer to the [Admin guide for Miro MCP][1].
...
## Authorizing Miro's MCP Server
  ...
  2. Follow the [OAuth authentication flow][2].
...
Most MCP Clients offer a streamlined installation process:
  ...
  4. Enter [`https://mcp.miro.com`][3] when prompted.
...
For detailed installation instructions for specific tools, refer to our developer documentation:
  ...
  * [Cursor][4]
  * [Claude Code][5]
  * [VSCode and GitHub Copilot][6]
  * [Gemini CLI][7]
  * [Lovable][8]
  * [Windsurf][9]
  * [Replit][10]

   [1]: <https://help.miro.com/hc/en-us/articles/31625761037202>
   [2]: <https://developers.miro.com/docs/connecting-to-miro-mcp#miro-oauth-flow>
   [3]: <https://mcp.miro.com>
   [4]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#cursor>
   [5]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#claude-code>
   [6]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#vscode-and-github-copilot>
   [7]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#gemini-cli>
   [8]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#lovable>
   [9]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#windsurf>
   [10]: <https://developers.miro.com/docs/connecting-miro-mcp-to-ai-coding-tools#replit>
