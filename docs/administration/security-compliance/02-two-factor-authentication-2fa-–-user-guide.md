---
title: Two-factor authentication (2FA) – user guide
...
:::tip
Learn how to enable two-factor authentication (2FA) for your organization for [Enterprise plans](../../enterprise-administration/security-integrations/two-factor-authentication-2fa/01-enterprise-two-factor-authentication-2fa-–-admin-guide.md), and [all other plans](01-two-factor-authentication-2fa.md).
:::
...
2. Click **I have an authenticator app** in the Miro 2FA setup screen.
   ...
   ![2FA-setup-step-1-Confirmation-of-authenticator-app-download.png](images/27601397095698_2FA-setup-step-1-Confirmation-of-authenticator-app-download.png)
...
3. Using the authenticator app, you now have two options:
   ...
   3. After scanning, click on **I scanned the code**
      ...
      ![2FA-setup-step-2-Scan-QR-code.png](images/27601422721298_2FA-setup-step-2-Scan-QR-code.png)*Scanning the QR code*
   ...
   4. After adding the code to the app, click on
      **I added the code** in Miro.
      ...
      ![2FA-setup-step-2-copy-code-and-add-to-authenticator-app..png](images/27601397098898_2FA-setup-step-2-copy-code-and-add-to-authenticator-app..png)*Copying the Miro code to paste in the authenticator app*
4. The authenticator app will generate a 6-digit verification code. Enter this code in Miro and click **Verify code**.

   ![2FA-setup-step-3-enter-6-digit-code.png](images/27601422725906_2FA-setup-step-3-enter-6-digit-code.png)
...
5. After successfully verifying your account with the 6-digit code, Miro will provide a recovery code. Click **Copy** to save this code securely. It's crucial to have this code as it allows you to reset your 2FA in case you lose access to your authenticator app.
   ...
   ![Save-2FA-recovery-code.png](images/27601422727314_Save-2FA-recovery-code.png)*Saving the recovery code*
...
![2fa-user-guide.png](images/27601397105298_2fa-user-guide.png)
*Signing into Miro with 2FA*

You have 3 attempts before you will be prompted to restart the sign-in process.

![Too-many-attempts.png](images/27601397107474_Too-many-attempts.png)*Too many sign-in attempts with 2FA*
...
![2FA-signin.png](images/27601397108882_2FA-signin.png)
...
![Reset-two-factor-authentication.png](images/27601422733714_Reset-two-factor-authentication.png)*The option to reset two-factor authentication*
...
1. Click on **Ask your admin to reset**.
   ![2fa-user-reset.png](images/27601397113106_2fa-user-reset.png)
