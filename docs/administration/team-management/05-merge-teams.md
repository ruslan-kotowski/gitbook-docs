...
2. Select **Filters**, and under **Teams** select your team.
   ![all-company-teams.png](images/25008766159634_all-company-teams.png) *Filtering users*
3. Select **All users**.
4. Select **Bulk actions > Add or move to a team**.
   A pop-up opens.
5. Choose the target team.
   ![move-to-a-team.png](images/25008761562642_move-to-a-team.png)*Move team members to another team*
6. Select **Add**.
