---
title: Volume discounting overview
...
Miro offers a 25% volume discount for teams upgrading from a Free to Business plan. A volume discount ensures that you can unlock greater value as your team grows, where the cost per user decreases with volume.
...
**More information:** See [Pricing with volume discount](#pricing-with-volume-discount).
