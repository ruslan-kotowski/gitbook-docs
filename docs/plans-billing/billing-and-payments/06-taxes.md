...
1. Click on the **+ Add company info** button and complete the fields shown. You will need to have ‘Australia’ or ‘New Zealand’ selected as the country.
   ![Taxes_billing_info_formatted.png](images/21019603651218_Taxes_billing_info_formatted.png)
...
2. Fill in the **Company Name** and **Address** details and add your ABN or GST ID (NZ) to the **Tax ID** field.
   ...
   - New Zealand customers will not see this checkbox.![taxes_company_info_and_tax_id_formatted.png](images/21019592631826_taxes_company_info_and_tax_id_formatted.png)
...
3. Miro will now do a check with our tax provider automatically to make sure the tax ID provided is valid. If valid, the tax amount shown in the payment summary will be reduced to zero.
   - Invalid IDs or when a checkbox is not provided will result in GST being charged.![taxes_billing_order_summary_formatted.png](images/21019603655442_taxes_billing_order_summary_formatted.png)
...
5. Miro will perform a check with our tax provider automatically to make sure the tax ID provided is valid. If valid, future purchases will not have tax applied.
   ...
   - Miro will not adjust historical purchases if the tax IDs were not provided at the time of purchase.![taxes_billing_VAT_ID_formatted.png](images/21019592626450_taxes_billing_VAT_ID_formatted.png)*Declaring company GST registration*
