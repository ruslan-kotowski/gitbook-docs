...
2. To open Miro, click on the **Activities** tab.
   ...
   ![activities.jpg](images/21016020368914_activities.jpg)
   *Activities in Google Meet*
3. Select Miro on the list of apps.

   ![Miro_platform_in_Google_Meet.jpg](images/21016033814290_Miro%20platform%20in%20Google%20Meet.jpg)*Miro add-on in Google Meet*
4. Here, you will have the option to sign in to your Miro profile or start a board without a profile.
   ...
   ![sign_in_or_create_a_board.jpg](images/21016033809682_sign%20in%20or%20create%20a%20board.jpg)
   *Sign-in option for new Miro users*
5. Once you are signed in, you will see all of your boards. Select the board you want to use in the meeting. You can only select boards that you're allowed to edit. ![google_meet_board_picker.png](images/21016020380562_google_meet_board_picker.png)
...
6. Select the right level of board access for everyone in the meeting and click **Embed board**. You can choose between four options: allow view/comment/edit access, or leave the board private and available for signed-in Miro users who have access to the board on the Miro side.
   ...
   ![google_meet_board_access_settings.png](images/21016020382098_google_meet_board_access_settings.png)*Board access settings inside Google Meet*
7. Click **Start activity** to share the Miro board with everyone in the meeting. The meeting will open in center stage. You’ll see a confirmation message with all the users you invited to work on the board.
   ...
   ![google_meet_starting_collaboration.png](images/21016020384018_google_meet_starting_collaboration.png)*Starting an activity on a Miro board in Google Meet*Meeting attendees will receive a pop-up notification requesting them to join the board to collaborate.

   ![Google_Meet_Miro_collaboration.jpg](images/21016033814802_Google%20Meet%20Miro%20collaboration.jpg)

Here's how Miro for Google Meet looks for presenters and attendees:

![google_meet_presenter_view.png](images/21016033821458_google_meet_presenter_view.png)*Presenter view in Miro for Google Meet*

![google_meet_attendee_view.png](images/21016033817746_google_meet_attendee_view.png)*Attendee view in Miro for Google Meet*
...
2. A new pop-up will open asking you to confirm. Click **Continue** to end the activity and return to your call. This will end the Miro collaboration, but you can always start a new collaboration or select a different board by clicking the **Activities** icon in the bottom-right corner of Meet.
   ...
   ![google_meet_end_activity.gif](images/21016033824146_google_meet_end_activity.gif)*Ending collaboration on a Miro board in Google Meet*
