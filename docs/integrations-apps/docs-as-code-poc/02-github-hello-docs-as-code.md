---
title: '[GitHub] Hello, docs-as-code!'
...
![image (7).png](images/30633427717522_image%20(7).png)

Updating a Trello card widget

![image (8).png](images/30633425312402_image%20(8).png)
...
| Scope | Description |
| --- | --- |
| Cards (read and write) | Grants the integration permission to read existing cards and create or modify cards within Trello. |
| Members (read) | Grants the integration permission to read member information within Trello, typically for assigning cards or displaying member names. |
| Labels (read) | Grants the integration permission to read labels associated with cards in Trello. |
| Boards (read) | Grants the integration permission to read board information and lists within Trello. |
...
The Trello integration is available for Miro's Business and Enterprise plans. Rest API
