---
title: Jira hierarchy in Tables
article_id: 32534655605010
sidebar_position: 2
created_at: '2026-01-14T09:19:57Z'
...
availability:
  roles: team_member
  plans: business, Enterprise with Advanced license
...
4. Add your issue(s) as the **Table** Format.
   ![](images/32535032016146_image.png) *The add-as selector enables you to choose the Table Format.*
5. Click **Add** ***x**.*
...
2. Click **Import child records**.
   The **Select issues** modal opens.
   ![](images/32535263274770_image.png) *After you import issues, you can import child issues to your table.*
...
![](images/32535397973010_image.png) *Toggle nesting view for parent and child issues.*
...
![](images/32535469507730_image.png) *Change the layout for your Jira issues table.*
