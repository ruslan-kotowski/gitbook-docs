...
article_id: 11277718194322
sidebar_position: 6
created_at: '2023-05-02T11:16:02Z'
updated_at: '2026-01-23T12:19:36Z'
draft: false
availability:
  plans: enterprise
  roles: company_admin
...
5. If you select **Specific** **teams can use**, click **+ Add teams**.
   A dropdown opens.
6. Search or scroll to find and select teams to grant access to. To add teams, click **+**. To remove a team, click **x** next to the team name.

:::note
You can grant feature activation for all teams in your organization. A recommended practice is to start with one team to test out the capabilities, then expand to other teams before rolling out across the organization.
:::

![feature-activation-1.png](images/23034308277266_feature-activation-1.png)
...
![feature-activation-talktrack.png](images/23034308281362_feature-activation-talktrack.png)
