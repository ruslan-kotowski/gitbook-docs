---
title: X UPLIFT DUP - Team management on Enterprise Plan
article_id: 22584346031762
sidebar_position: 3
created_at: '2024-11-12T18:33:14Z'
...
Within your company settings you can find the overview of all Teams within your organization. Here you can see the total number of users and boards within each team, and [create new teams](09-create-a-new-team-on-enterprise-plan.md).

Go to **Company** settings **> Teams**.

:::tip
Use bulk actions, search, and filter options to help you navigate teams.
:::

![team-entrypoint.png](images/22584346009746_team-entrypoint.png)
...
![team-name.png](images/22584346010514_team-name.png)
...
![team-logo.png](images/22584346012306_team-logo.png)
...
![team-leave-delete.png](images/22584352054546_team-leave-delete.png)
...
![team-user-settings.png](images/22584352055442_team-user-settings.png)
...
![team-user-profile.png](images/22584346018578_team-user-profile.png)
...
![team-billing-contact.png](images/22584352056338_team-billing-contact.png)
...
![team-apps.png](images/22584352057106_team-apps.png)
...
![team-remove-app.png](images/22584352057490_team-remove-app.png)
...
![team-add-apps-non-admin.png](images/22584346024594_team-add-apps-non-admin.png)
...
![team-download-csv.png](images/22584352060818_team-download-csv.png)
