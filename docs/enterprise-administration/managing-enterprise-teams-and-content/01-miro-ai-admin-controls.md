...
Miro AI admin controls enable Enterprise Company Admins to decide which AI capabilities are available in their organization and manage who can use them. Admins can also view the models that power each AI feature. Use these controls to roll out AI safely and meet security requirements while driving adoption of AI capabilities. In the Admin Console, you can control specific AI features, like image generation or text editing capabilities, which helps prioritize features based on organizational needs and security requirements. For more information on the Miro AI features you can toggle, see [Miro AI admin controls reference](#miro-ai-admin-controls-reference).

## Enable, restrict, or remove Miro AI capabilities

1. Go to the **Admin Console**.
   From your Miro dashboard, click your avatar in the top-right, then select **Admin Console**.
2. In the left sidebar, select **Miro AI** > **Capabilities**.
3. For the capability you want to manage, select an option from the drop-down list:
   - **Everyone** – Enables the capability for all users and teams across your organization (including any teams created later). Any team-level restrictions are overridden.
   - **No one** – Removes access to the capability for everyone. In the confirmation dialog, select **Remove access**.

:::note
When a Miro AI capability category is deactivated, users can no longer access that capability and all its associated features on any Miro board. If you deactivate all Miro AI capabilities, **Create with AI** appears disabled on the board.
:::
   - **Specific teams** – Select the checkbox next to each team you want to allow, then click **Save**.
