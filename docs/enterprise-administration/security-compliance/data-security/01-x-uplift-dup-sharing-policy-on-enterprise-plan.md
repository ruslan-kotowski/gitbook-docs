---
title: X UPLIFT DUP - Sharing policy on Enterprise Plan
article_id: 22584956426258
sidebar_position: 1
...
![sharing-allowed-domains.png](images/22584956412562_sharing-allowed-domains.png)
...
![validate_against_the_allowlist.jpg](images/22584956415250_validate%20against%20the%20allowlist.jpg)*Users whose email addresses do not match the allowlist*
...
![sharing-team-allowed-domains.png](images/22584956415762_sharing-team-allowed-domains.png)
...
![can_t_share_outside_the_allowlist.jpg](images/22584956416146_can't%20share%20outside%20the%20allowlist.jpg)*The board cannot be shared with a user whose domain is not in the allowlist*
...
![1-1.png](images/22584978808082_1-1.png)
...
![sharing-allow-public.png](images/22584956418578_sharing-allow-public.png)
*Sharing via a public link for viewing, commenting, and editing is enabled*
...
![sharing-public-link.png](images/22584978809746_sharing-public-link.png)
...
4. Set the number of days before inactive links expire. You can choose between 7 and 999 days.

![sharing-expire-link.png](images/22584978810386_sharing-expire-link.png)
...
![sharing-require-password.png](images/22584956420370_sharing-require-password.png)
...
- When the "*Expire link when board has been inactive for 'x' days*" option is set, a clock icon will appear in the Share dialog box, with a message that public access will disappear after the specified number of days.
  ![1-2.png](images/22584978811282_1-2.png)
...
![complex-board-password.png](images/22584956422418_complex-board-password.png)
...
1. Go to **Teams** and select the team you wish to configure.
2. Go to **Settings** and scroll down to **Sharing settings**.
3. In **Board sharing,** choose whether sharing with a team is allowed or not allowed. For company-wide settings, choose whether the company can view and comment on shared boards, view/comment/edit, or whether sharing is not allowed.![sharing-board-sharing.png](images/22584956422802_sharing-board-sharing.png)*Board sharing settings on Enterprise plan*
...
![1-3.png](images/22584978812178_1-3.png)
...
![1-4.png](images/22584956423442_1-4.png)
...
![sharing-moving-boards.png](images/22584956424082_sharing-moving-boards.png)
...
![sharing-restrict-templates.png](images/22584978813202_sharing-restrict-templates.png)
