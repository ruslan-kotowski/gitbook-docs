...
The following key benefits help you turn data into action and strengthen your role as a Miro Company Admin:
...
The Miro AI dashboard provides insights that enable you to track adoption and understand how Miro AI is used across your organization through metrics such as teams using AI, people using AI, created with AI, AI-powered actions, Sidekick collaborations, Top AI users, and Executed AI flows. For more information, see the [Miro AI dashboard documentation](03-miro-ai-dashboard.md/).

:::note
AI Credits are not directly correlated with the AI usage metrics displayed in this dashboard.
:::
