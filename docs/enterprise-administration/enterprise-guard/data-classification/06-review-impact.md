...
![Collapsible Distribution of classification levels section](images/18935265584914_Collapsible_Distribution_of_classification.png)
...
![Column-based user interface displaying the number of boards added, number of boards removed, and updated total for each classification level](images/18931585985810_columnview.png)
...
![Drill-down feature with comprehensive view of updates](images/18935167416210_drilldown_feature_classification.png)
...
*![Configure classification Review impact](images/18934977949970_guardrails.png)
