...
4. On the **Cases** page, click **Create case**.
5. On the **Create case** page, enter the appropriate information for each field. The following table lists each field and its description.

   |  |  |
   | --- | --- |
   | **Field** | **Description** |
   | Case name  **(required)** | Name of the case.  Max length: 60 characters. |
   | Description  **(optional)** | Description for the case.  Max length: 300 characters. |
6. Click **Create case**. The case is created and appears in the list of cases on the eDiscovery page. You can now proceed to add a legal hold to the case.
