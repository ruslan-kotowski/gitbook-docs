...
:::note
To edit disposition policies, you must have the [Data Governance Admin role](../../enterprise-subscription-management/enterprise-guard-overview/03-understand-admin-roles-and-their-privileges.md). To request for the Data Governance Admin role, contact your Company Admin.
:::

To edit a disposition policy, perform the following steps:
...
5. Click **Edit** at the top-right of the page, and then edit the required fields. The following table lists each field and its description.
...
8. To save the configuration and apply the disposition policy, click **Publish**.
   If you do not have disposition notifications enabled, the The **Turn on disposition notification** dialog box appears.
