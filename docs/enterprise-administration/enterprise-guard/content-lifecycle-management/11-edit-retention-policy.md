...
:::note
To edit retention policies, you must have the [Data Governance Admin role](../../enterprise-subscription-management/enterprise-guard-overview/03-understand-admin-roles-and-their-privileges.md). To request for the Data Governance Admin role, contact your Company Admin.
:::
...
4. On the **Retention** **policies** page, click the retention policy that you want to edit.
   The page displaying information related to the policy appears.
5. Click **Edit** at the top-right of the page, and then edit the required field. The following table lists each field and its description.
...
6. When you are done with Click **Next**.
