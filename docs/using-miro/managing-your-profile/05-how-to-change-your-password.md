...
article_id: 360017731433
sidebar_position: 5
created_at: '2019-02-11T10:14:31Z'
...
![change_password_in_Miro.jpg](images/21017013080210_change%20password%20in%20Miro.jpg)*Changing a password in Miro profile settings*

### How to reset your password

1. To reset your password, on the [Miro login page](https://miro.com/login/) click **Forgot** **password?**.
   ![](images/31766547704850_image.png)***Forgot password?** links to the password reset instructions. You can also click **reset your password** at the bottom.*
...
![](images/31766557025298_image.png)*Miro indicates which password requirements are met in real time.*
