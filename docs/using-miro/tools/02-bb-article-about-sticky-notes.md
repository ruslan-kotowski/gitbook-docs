---
title: BB article about Sticky notes
article_id: 25953130447250
sidebar_position: 2
...
Click the **sticky note** (![icon-sticky.svg](images/25953100365714_icon-sticky.svg)) icon on the toolbar or [press N on your keyboard](../working-on-the-board/06-shortcuts-and-hotkeys.md) to start using the tool. You can also add a sticky note by dragging and dropping it right from the toolbar or by clicking the board and dragging your cursor holding the left mouse button.

You can change the shape of a sticky note by clicking the icon on the sticky's context menu.

![sticky-switch-type.png](images/25953100366994_sticky-switch-type.png)
...
![sticky-fill-color.png](images/25953130442642_sticky-fill-color.png)
*Sticky note colors*
...
![sticky-align.png](images/25953100369042_sticky-align.png)
