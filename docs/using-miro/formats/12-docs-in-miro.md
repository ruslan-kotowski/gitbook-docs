...
1. Click on the **Tools, Media and Integrations** (![icon-tools.svg](https://help.miro.com/hc/article_attachments/28774393551890)) icon.
2. Search for and select **Docs**.
3. Click anywhere on the canvas to add it.

Docs are also included in some board templates.

![](images/20164663481362_33fb246e-3278-4496-8a69-5bd34721a01e.png)

*Adding a new document from the Docs icon*

You can also add a Doc with Miro AI:

1. Click on the **Miro AI** (![icon-ai.svg](https://help.miro.com/hc/article_attachments/28774393552274)) icon in the Creation toolbar.
...
![miro-ai-docs.png](https://help.miro.com/hc/article_attachments/28774378367762)
...
2. Click on the **Miro AI** (![icon-ai.svg](https://help.miro.com/hc/article_attachments/28774393552274)) icon in the context menu.
3. Select **Document** from the submenu.
4. Pick a template or use a **Custom Prompt**.
5. The Doc is created and placed on the board.

![doc-from-stickies.png](images/21909744798482_doc-from-stickies.png)
...
![docs-new.png](images/21909744799378_docs-new.png)
...
![docs-full-screen-icon.png](images/21909726408722_docs-full-screen-icon.png)
...
![docs-focus-mode.png](images/21909726410514_docs-focus-mode.png)
...
![Drag and drop data widgets into a Miro Doc.](images/24096296753298_docs-tables-widget.gif)
...
![docs-formatting-toolbar.png](images/21569150516626_docs-formatting-toolbar.png)
...
![docs-formatting.png](images/21569150520594_docs-formatting.png)

*The Docs Text style icon menu*

You can select from a variety of heading and list types to add structure to your doc:

![docs-headings.png](images/21569150529426_docs-headings.png)
...
![docs-keyboard-shortcuts.png](images/21569106652178_docs-keyboard-shortcuts.png)
...
![](images/24096296756626_image.png)
...
![Add user chips anywhere in a Miro doc.](images/24096318691474_image.png)

*Add user chips anywhere in a Miro doc*

Hover over an @user chip to see information about the user.

![User chips include information about the user.](images/24096296760338_image.png)
...
![date-chips.png](https://help.miro.com/hc/article_attachments/27939784696466)
...
![date-chips-next-week.png](https://help.miro.com/hc/article_attachments/27939806470034)
...
![date-chip-calendar.png](https://help.miro.com/hc/article_attachments/27939806470802)
...
Docs can be exported to PDF or Markdown formats from the **More icon** (![icon-main.svg](images/22916604338834_icon-main.svg)) in the Context menu.
