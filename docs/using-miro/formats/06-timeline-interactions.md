---
title: Timeline interactions
article_id: 32042788697234
sidebar_position: 16
created_at: '2025-12-22T18:19:01Z'
...
To change the time range shown on the Timeline, elect the **calendar icon** (![icon-calendar.svg](images/32042780459282_icon-calendar.svg)) on the upper left side of the Timeline widget to choose your start and end dates. The Timeline scales automatically to match your selection.

You can also use the dropdown to select whether to scale the Timeline to **Days**, **Weeks**, **Months**, **Quarters**, or **Years**.

![](images/32042788691858_image.png)
...
![](images/32042780459794_image.png)
...
![](images/32042788692498_image.png)
...
![](images/32042780460434_image.png)
...
![](images/32042788695442_image.png)
...
![timeline-rearrange.gif](images/32042788695826_timeline-rearrange.gif)
...
![timeline-grouping.png](images/32042788696082_timeline-grouping.png)
