...
![](images/25648009238546_image.png)
...
![slides-update-2.png](images/27821820418578_slides-update-2.png)
...
:::tip
You can also export in focus mode. In the upper right, click the **vertical three dots** (![icon-main.svg](images/27821820421266_icon-main.svg)) icon and then select **Export as PDF**.
:::
...
- **Multi-lane presentations**
  ...
  ![Slides-multi-lane.gif](images/26764078989970_Slides-multi-lane.gif)*Multi-lane example of Slides*
- **More**
