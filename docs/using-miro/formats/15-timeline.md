...
:::tip
In the records column, drag the right border to increase the width and fit longer strings of text.
:::
...
To change the time range shown on the Timeline, elect the **calendar icon** (![icon-calendar.svg](images/22913256738962_icon-calendar.svg)) on the upper left side of the Timeline widget to choose your start and end dates. The Timeline scales automatically to match your selection.

You can also use the dropdown to select whether to scale the Timeline to **Days**, **Weeks**, **Months**, **Quarters**, or **Years**.

![](images/31345792716690_image.png)
...
![](images/31345792718866_image.png)
...
![](images/31345792721170_image.png)
...
![](images/31345797705874_image.png)
...
![](images/31678656996498_image.png)
...
![timeline-rearrange.gif](images/22913194761362_timeline-rearrange.gif)
...
![timeline-grouping.png](images/22913256739730_timeline-grouping.png)
...
Any changes made in Miro will be reflected in Jira and vice versa. The following fields within the Timeline will sync to Jira:
...
**More information:** See [Tables](14-tables.md).
