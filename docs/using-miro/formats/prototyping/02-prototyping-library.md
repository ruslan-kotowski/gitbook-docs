...
![prototyping-library.png](images/31804538064914_prototyping-library.png)
...
1. On the canvas, from the [Creation bar](../../working-on-the-board/02-miro's-new-simplified-user-interface.md) click **Tools, Media and Integrations** (![icon-tools.svg](images/26758266547986_icon-tools.svg)).
