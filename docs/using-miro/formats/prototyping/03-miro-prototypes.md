...
2. Click **Sidekicks library**.
   ![](images/31911683121938_image.png)*Access Protoype in The Sidekicks library*
...
2. In the prompt box, click **Create prototype**.
   ...
   ![](images/32767961238290_image.png)*Start your prototype in the Sidekicks panel.*
...
1. For any prototype applied to the canvas, in the context menu click **Edit with AI**.
   The **Sidekick** panel opens.
   ![](images/33589790278034_image.png) *Edit with AI enables you to refine an existing prototype.*
...
4. Select **Import style from image**.
   ![](images/31911683124754_image.png)*Import styles and apply them to your prototype*
...
![](images/31911695765138_image.png) *Choose which refinement, or version, of your prototype to add to the canvas.*
...
![](images/32573389258770_Preview.png) *Hide or show connectors in Focus mode.*
...
![](images/29764067866130_image.png)
...
3. Click **Copy to Figma**.
   ...
   ![](images/32823636804242_image.png)*Copy your prototype to Figma.*
...
![](images/31911683128594_image.png)*A codebase AI editor like Cursor accepts a Miro board URL with board ID to generate code based on your prototype.*
