...
![Spaces-home-dash-anonymous.png](images/21102202591762_Spaces-home-dash-anonymous.png)
...
![](images/27812769890194_image.png)
...
1. From the board bar in the top-left of your Miro board, select the three vertical dots.
   The **Main menu** opens.
   ![Move a board to another Space from the Main menu.](images/21061987239954_spaces-move-space.png) *Move board to another space*
...
1. In the board sidebar, hover over the board you want to move, and select the three dots (**...**) to access the context menu.
   ![Move a board to another Space from the sidebar menu.](images/21061987243794_spaces-move-space-board-sidebar.png) *From the board sidebar, move board to another Space*
...
![](images/27506652618642_image.png)
