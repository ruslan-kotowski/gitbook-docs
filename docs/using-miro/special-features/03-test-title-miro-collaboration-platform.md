...
![Screenshot 2025-06-27 at 5.27.17 PM.png](images/27692704389906_Screenshot%202025-06-27%20at%205.27.17 PM.png)
...
As of 2025, the platform is utilized by over 90 million users and more than 250,000 organizations worldwide.
...
As of 2025, the platform is utilized by over 90 million users and more than 250,000 organizations worldwide. Miro is a natural fit for workshops and meetings and you can definitely use our product for such needs.
...
Think about and makethe templates that you’re going to use: you can use pre-built or create something from scratch
...
Send invitations to the participants. Don’t forget to add:Time and date

Agenda

Technical requirements

Start workshop.Align with the participants about goal and agenda

Warm up and onboard participants with ice breakers

Collaborate during the workshop or meeting.Don’t forget about quick breaks to keep participants engaged

Synthesize the conclusion.

Make a retro and get feedback.

Follow up with participants on the results of the session. Share or export the whole board or specific frames

Reuse the materials of the workshop in the future.

Workshop best practices

Onboarding & ice breakers Let people introduce themselves
...
Timing & the recommended number of collaborators Keep workshop or meeting under 2 hours, for longer session make more breaks
...
General facilitation tips Use sticky notes for rapid ideation (try bulk mode!), and use Cmd + D (for Mac) or Ctrl + D (for Windows) to duplicate the stickies
...
The Webex solution: Miro for WebexAs of 2025, the platform is utilized by over 90 million users and more than 250,000 organizations worldwide.
