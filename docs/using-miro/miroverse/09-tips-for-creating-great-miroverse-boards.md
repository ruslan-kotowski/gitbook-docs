---
title: Tips for creating great Miroverse boards
...
[Miroverse](01-what-is-miroverse.md) is Miro's community templates gallery, providing access to quality boards created by Miro creators. This platform allows you to explore a wide array of workflows, projects, and frameworks through easy search functionality or by browsing various categories.
...
For more on template criteria, visit our [Miroverse publishing checklist and guidelines](08-miroverse-publishing-checklist-and-guidelines.md)**.**
...
:::tip
Visit the [Creator Toolbox](https://miro.com/miroverse/creators/) for more Miroverse publishing tips and resources, plus access to the [Creator Community](https://miro.com/miro-creators/) and events.
:::
...
- **Write a detailed description:** Your [Miroverse description](10-tips-for-writing-a-miroverse-template-description.md) should include the following elements…
...
- **Include an example:** Add a filled-in version of your template to demonstrate its use. For inspiration, see [Alex’s Team Canvas](https://miro.com/miroverse/the-team-canvas/) or [Julia's Customer Question Board](https://miro.com/miroverse/the-question-board/).
...
- **Add a** [Talktrack](../facilitation-tools/asynchronous-tools/02-talktrack-board-recordings.md)**:** When users open a Miroverse template, they can view all your Talktracks. This 2-3 minute (recommended) video can be a high-level overview, a short walkthrough covering steps of the process, or even a live-action example of it in action.
...
- **Add a clear starting point and flow:** Ensure there is a distinct starting point and a logical flow throughout the board. Use numbers, arrows, [frames](../essential-tools/07-frames.md), or other wayfinders to outline a clear, intuitive progression. Remember, many cultures consume information left to right. For inspiration, see [Red Hat’s Building Team Collaboration](https://miro.com/miroverse/building-team-collaboration-workshop-sitvjf8itx6jzduk/) and [Tini Studio’s Diversity and Inclusion Workshop](https://miro.com/miroverse/diversity-and-inclusion-workshop-the-multiverse-toolkit/).
- **Guiding features:** Incorporate helpful elements such as [sticky notes](../essential-tools/14-sticky-notes.md) to indicate the expected number of responses, provide sentence starters to stimulate ideas, or showcase an example of the final result.
- **Accessibility**: Keep [inclusive design principles](../../getting-started/accessibility-in-miro/04-how-to-make-your-miro-boards-more-accessible.md) in mind and use the Miro Accessibility Checker which scans your Miro board and highlights areas that may not meet common accessibility standards, offering actionable suggestions for improvement.
- **Customizability**: Unlock most, if not all, elements of your board, allowing users to easily adapt and customize as needed.
...
- Add or enhance visuals using [iconfinder](../../integrations-apps/more-integrations/09-iconfinder.md), [Wireframe library](prototyping/02-prototyping-library.md), or emojis.
...
- [Set a relevant start view](https://community.miro.com/ask-the-community-45/how-to-set-start-view-687) and choose a similar screenshot for the thumbnail during the submission process. Ensure no Miro grid is visible and titles are framed appropriately.
...
Remember, a clean and well-organized design doesn't have to mean simple or boring — check out [Nhi Tran’s Retrospective](https://miro.com/miroverse/retrospective-emoji-4ohfgtdnpetyigth/) for inspiration.

## How to improve your template skills

We have ample resources available to help you create templates that stand out.

- Check out our [YouTube channel](https://www.youtube.com/@MiroHQ), including:
...
- Take [Miro Academy](https://academy.miro.com/) courses to boost your Miro skills:
  - [Getting started with Miro - What is Miro?](https://academy.miro.com/learn/course/getting-started-with-miro)
  - [Mapping and diagramming](https://academy.miro.com/learning-paths/mapping-and-diagramming-in-miro)
  - [Templates](https://academy.miro.com/courses/templates)
- [Sign up for events](https://community.miro.com/events) hosted by expert Creators
- Join the [Creator Community](https://miro.com/miro-creators/) to share your templates, ask for feedback, and get access to creator-led workshops.
