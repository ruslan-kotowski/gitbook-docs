...
Click the **sticky note** (![icon-sticky.svg](https://help.miro.com/hc/article_attachments/25382435009298)) icon on the toolbar or [press N on your keyboard](../working-on-the-board/06-shortcuts-and-hotkeys.md) to start using the tool. You can also add a sticky note by dragging and dropping it right from the toolbar or by clicking the board and dragging your cursor holding the left mouse button.

You can change the shape of a sticky note by clicking the icon on the sticky's context menu.

![sticky-switch-type.png](images/25382421657490_sticky-switch-type.png)
...
![sticky-fill-color.png](images/25382421659154_sticky-fill-color.png)
*Sticky note colors*
...
![sticky-align.png](images/25382421660434_sticky-align.png)
...
1. Click the **Tools, Media and Integrations** (![icon-tools.svg](https://help.miro.com/hc/article_attachments/32071641952658)) icon.
...
![sticky-show-author.png](images/25382421661458_sticky-show-author.png)
...
![sticky-tag.png](https://help.miro.com/hc/article_attachments/25382435019666)
*Using tags*
...
![sticky-emoji.png](images/25382421664786_sticky-emoji.png)
