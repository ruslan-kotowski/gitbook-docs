...
availability:
  ...
  platforms: browser, desktop, mobile, tablet, Interactive display
---

Create engaging and professional-looking boards and presentations. Browse, search, and swap a variety of images and icons from Unsplash and Fontawesome in a single library.

## Getting started with Images and Icons

Admins can manage access to the Unsplash app in their [app management](../../enterprise-administration/managing-apps-on-enterprise-plan/02-app-management.md) settings, allowing or restricting access at any time.

:::warning
If you're unable to access the Unsplash app from your board, check with your Admin to make sure that the app has been approved for your organization.
:::
...
![Images-and-Icons-tabs-visible-when-allowed-in-app-settings.png](images/21016134851602_Images-and-Icons-tabs-visible-when-allowed-in-app-settings.png)
...
![Opening-Images-and-Icons-app.png](images/21016134850706_Opening-Images-and-Icons-app.png)
...
![Browsing-image-categories.png](images/21016121506834_Browsing-image-categories.png)
...
![Viewing-image-details.png](images/21016134848274_Viewing-image-details.png)
...
![Click-to-select-and-place.png](images/21016134854034_Click-to-select-and-place.png)
*Adding an image to the board*

### Icons by Fontawesome

Access a wide range of icons from Fontawesome. Browse icon packs, or search for a specific icon.

![fontawesome.png](images/31565336864018_fontawesome.png)
*Browsing icons*

To add an icon, click to select and then place it on your board, or use drag-and-drop.

### Change the color of an icon

1. Select an icon on the board to open the context menu.
2. Click **Fill Color**.
3. Select what color you wish to change the icon to.

![fillcolor.png](images/31565314568338_fillcolor.png)
...
![Swapping-an-image.png](images/21016134852626_Swapping-an-image.png)
*Swapping icons and images on the board*

## Styling images

You can easily enhance the appearance of your images in Miro using various styling options. Whether you want to add a border, adjust the border opacity, or round the corners, Miro provides flexible options for customizing your images to fit your board's aesthetic.

![imagestyling.png](images/25592371909522_imagestyling.png)
...
- **Border Opacity**: Change the opacity of your border using a slider, making it more transparent or fully opaque.
- **Rounded Corners**: Use the slider to adjust the corner radius, which will give the image softer edges. Set it to 0 for sharp corners, or increase the value for more rounded corners.
...
![multi-crop.gif](images/25827434689298_multi-crop.gif)
...
Further image editing options are available with Adobe Express, right on your board. Click on **Edit image** in the context menu to launch Adobe Express. **More information:** [Adobe Express (BETA)](../../integrations-apps/adobe/01-adobe-express.md).
