...
availability:
  ...
  roles: board_editor, board_owner, Commenters, company_admin, Content admins, Members,
    team_admin, User admins, Viewers
---
...
![](images/22651019573266_Video-Calls.gif)
...
2. Under **Video  calls**, select **Start video call**. ![Start video call button for Video Calls](images/22552465694866_image.png)
...
2. Under **Video calls**, select **Join**.
   ![The Join button during an active call.](images/22656717333522_Recordings%20(1).png)
...
![Schedule a call for Video Calls](images/22552465702418_image.png)
...
- **Start sharing**
  ...
  ![](images/22552465707666_image.png)
...
2. Click on the **Record** icon.
   ...
   ![video-call-record-icon.png](images/28571506389010_video-call-record-icon.png)
...
3. Select whether you want to **Start live transcript too** on the call.
   ...
   ![video-call-recording.png](images/28571521714834_video-call-recording.png)
...
1. Click on the **vertical three dots** (![icon-main.svg](images/28571506393106_icon-main.svg)) icon in the picture-in-picture window to open the main menu.
