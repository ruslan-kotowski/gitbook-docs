...
To proceed with setting up Miro Insights, see the [Miro Insights setup guide](set-up-and-manage-miro-insights/01-set-up-miro-insights.md) to connect your integrations and start populating your backlog.
