---
title: Why does Miro keep logging me out?
...
:::note
Note that it’s only necessary to login again to one board on any browser tab. Doing so will log you back into all boards you’re currently accessing.
:::
...
*Can I change the timeout value myself?*Idle Session Timeout limits are set by your organization’s Miro administrator. Contact your administrator to inquire about changes to this setting.

*I’m a Miro administrator. Where can I learn more about idle session timeouts and make updates?*

You can learn more about this feature and how to make updates in the [idle session timeout article](../../../enterprise-administration/security-integrations/security-management/02-idle-session-timeout.md).

*Is the idle session timeout feature available on every Miro plan?*

Idle session timeout is only available on the Enterprise plan. If you’re facing login/logout issues and you do not have Miro Enterprise, check this [login issues article](../../tools/troubleshooting/09-i-can't-log-in.md) for alternative solutions.
