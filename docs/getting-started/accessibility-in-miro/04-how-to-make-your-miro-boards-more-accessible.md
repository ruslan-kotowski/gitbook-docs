---
title: How to make your Miro boards more accessible
...
The Miro Accessibility Checker empowers all users to create accessible boards. The checker scans your Miro board to identify areas that may not meet accessibility standards, providing you with actionable insights to improve your content for all users.

The checker performs the following checks:
...
1. Open a Miro board.
2. From the [Board bar](../../using-miro/working-on-the-board/02-miro's-new-simplified-user-interface.md), select the vertical three-dots.
...
- Use [frames](../../using-miro/essential-tools/07-frames.md) to structure board content and make sure no board objects are placed outside frames.
...
![accessibility-alt-text.png](images/21647616796690_accessibility-alt-text.png)
*Adding alt-text to images*

### Adding alt-text to images

Provide text alternatives/descriptions for any complex visuals like diagrams — use [text](../../using-miro/essential-tools/16-text.md) or [shape](../../using-miro/essential-tools/11-shapes.md) to insert the annotation.

### Using sticky note colors and tags consciously

Using various [sticky note colors](../../using-miro/essential-tools/14-sticky-notes.md) is a great way to cluster ideas or differentiate between contributors. If you are looking to make your workshop more inclusive, there is an alternative to sticky note colors – using tags for identifying sticky note authors or categorizing sticky notes on the board.

![accessibility-tags.png](images/21647563445650_accessibility-tags.png)
...
![accessibility-zoom.png](images/21647563446290_accessibility-zoom.png)
...
![accessibility-hide-cursors.png](images/21647616803858_accessibility-hide-cursors.png)
...
![accessibility-reduce-motion.png](images/21647563446802_accessibility-reduce-motion.png)
...
![accessibility-background-color.png](images/21647563448210_accessibility-background-color.png)

*Using custom board color*

### Choosing dark colors for objects on the board

You can create [sticky notes](../../using-miro/essential-tools/14-sticky-notes.md) and [shapes](../../using-miro/essential-tools/11-shapes.md) with the darkest colors as well as white/light grey text colors where appropriate.

![accessibility-color-tools.png](images/21647616804626_accessibility-color-tools.png)

*The color of the background and text of a shape*

## Using guidelines for accessible facilitation

Facilitation before, during and after collaborative sessions can have a big impact on accessibility of collaboration. Read our guide to learn about [10 Principles For Inclusive Collaboration](https://miro.com/10-principles-for-inclusive-collaboration/)

### Enabling visitors for easier access to boards

For easier access to the board, a facilitator can make the board available for [visitors](../../using-miro/sharing-boards/08-collaboration-with-visitors.md). This will mean that those who receive the link to the board will be able to open it without having to sign in or sign up to Miro. To enable this, go to Share and choose Anyone with the link can edit (available on Starter, Business, Education, and Enterprise plans). [Learn more](../../using-miro/sharing-boards/08-collaboration-with-visitors.md).

![accessibility-board-sharing.png](images/21647563449106_accessibility-board-sharing.png)
...
For smoother navigation on the board, a facilitator may use [bring everyone to me](../../using-miro/facilitation-tools/04-attention-management.md) functionality. This will mean that everyone who has the board open is able to follow the facilitator on the board wherever on the board they are. [Learn more](../../using-miro/facilitation-tools/04-attention-management.md).

![accessibility-bring-everyone.png](images/21647563449618_accessibility-bring-everyone.png)

*Bringing all collaborators to your view*

Alternatively, a facilitator may also [Copy link](../../using-miro/working-on-the-board/16-internal-and-external-linking.md#links-to-objects-on-the-board) to any object on the board and share it with collaborators. To do that, click on any object, click the **three dots** (**...**) menu, and then **Copy link**.

![accessibility-copy-link.png](images/21647563450642_accessibility-copy-link.png)
