---
title: How to access Miro boards with assistive technologies
...
> **💡** Visit the [Miro Accessibility Hub](https://miro.com/accessibility-statement/) to learn more and stay updated on all our latest developments.

:::tip
We are dedicated to continuously improving our users' accessibility experience. Please share your feedback at [accessibility@miro.com](mailto:accessibility@miro.com).
:::

## Recommended browsers and screen readers

:::note
The Miro Accessibility team is continuing to work on enhancing compatibility with assistive technologies, and will be updating this list as it becomes more compatible with other browsers, screen readers, and devices.
:::
...
:::note
We currently provide limited support for assistive technologies on mobile and tablet devices.
:::
...
:::note
To learn how to enable Voice Control on MacOS, see [Apple support](https://support.apple.com/en-gb/102225).
:::
...
1. *Press **Sticky note***
2. *Press **Place light yellow sticky note***
3. *Press **Enter** key*
4. *“Hello World”*
5. *Press **Escape** key*
...
:::note
To learn how to enable Voice Access for MS Windows, see [Microsoft Support](https://support.microsoft.com/en-gb/windows/use-voice-recognition-in-windows-83ff75bd-63eb-0b6c-18d4-6fae94050571).
:::
...
> **💡** Refer to our [toolbars article](../start-here/your-first-board/05-toolbars.md) for a full overview.
