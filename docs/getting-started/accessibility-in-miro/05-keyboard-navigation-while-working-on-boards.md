---
title: Keyboard navigation while working on boards
...
- Press **Tab** to navigate between [toolbars](../start-here/your-first-board/05-toolbars.md) and panels.
- Use the arrow keys to navigate through toolbar items and menus.
- Use up and down arrows to navigate the [creation toolbar](../start-here/your-first-board/05-toolbars.md#creation-toolbar).

## Keyboard navigation

### Toggle on/off single key shortcuts

By default, single character shortcuts are toggled on. To toggle them off (such as to prevent interference with assistive technologies like screen readers):

1. Click the **Main menu** (![icon-main.svg](images/31688274627218_icon-main.svg)) icon in the board toolbar.
2. Select the **Accessibility** menu option to open the submenu.
3. In the submenu, toggle off (or on) the **Single-character shortcuts**.
...
:::note
The keyboard navigation only works when objects are selected, not while they are being edited.
:::
...
### Select multiple board objects

macOS

- Select the first object.
- Press **Cmd** + **Option** + **Shift** + **Arrow** to choose each additional object.

Windows

- Select the first object.
- Press **Ctrl** + **Alt** + **Shift** + **Arrow** to choose each additional object.

### Resizing board objects

macOS

- Select the board object you'd like to resize.
- Press **Cmd** + **Option** + **Shift** + **Plus/Minus**.

Windows

- Select the board object you'd like to resize.
- Press **Ctrl** + **Alt** + **Shift** + **Plus/Minus**.
...
- Tab through to the [creation toolbar](../start-here/your-first-board/05-toolbars.md#creation-toolbar), then press the **up or down arrows** until you reach the desired object type (shape, sticky note, etc.) and press **Enter**, then **Tab** to select the object, and press **Enter** again to create the object. The object will be placed on the board.
...
### Create diagramming connections

You can create connecter lines between objects on the board.

- Tab to the first object you want to connect.
- Press Cmd+K (Mac) or Ctrl+K (Windows) to open the Command Palette.
- Type and select **Create connection to**.
- Tab to the second object.
- Press Cmd+K (Mac) or Ctrl+K (Windows) to open the Command Palette.
- Type and select **Connect to this object**.
...
:::tip
To provide feedback on the above shortcuts, please get in touch with us at
