...
- [Google Play](https://play.google.com/store/apps/details?id=com.realtimeboard)
- [Apple App Store](https://apps.apple.com/us/app/miro-formerly-realtimeboard/id1180074773)
- [Microsoft Store](https://www.microsoft.com/p/miro-formerly-realtimeboard/9n236hqqtvnh?cid=msft_web_chart&activetab=pivot:overviewtab)

## Using Miro app for tablets

Open your boards from the dashboard to start collaboration:

![dashboard_on_tablet.jpg](images/21017005169938_dashboard%20on%20tablet.jpg)
*Miro Tablet app dashboard*

![board_on_tablet.jpg](images/21017005173650_board%20on%20tablet.jpg)
...
You can use any type of pen tool with Miro while working on a tablet, including Stylus, Apple Pencil, Surface Pen, and Samsung S Pen. Enhance your Miro Tablet App experience with features like [pen, highlighter](../../using-miro/essential-tools/10-pen.md) and [smart drawing](../../using-miro/essential-tools/12-smart-drawing.md).
...
![Only_draw_with_Stylus.png](images/21016967659026_Only%20draw%20with%20Stylus.png)*Only draw with Stylus enabled*
...
- [Dropbox](../../integrations-apps/more-integrations/06-dropbox.md) plugin is unavailable
- Only JPG files can be [uploaded](../../using-miro/import-and-export/import/05-uploading-files-to-boards.md) to boards from the device
- [Upgrading](../../plans-billing/manage-your-subscription-and-plan/03-upgrade-your-plan.md) and [changing the team size](../../plans-billing/billing-and-payments/04-miro-billing.md) are not available in the Tablet app. You can use the tablet browser for this purpose
...
:::note
If you experience any other **performance issues** when working on a tablet, check possible solutions [here](../../using-miro/tools/troubleshooting/16-troubleshooting-mobile-and-tablet-device-issues.md).
:::

### Frequently asked questions

1. *Can I reassign* [*mind map*](../../using-miro/advanced-tools/03-mind-map.md) *nodes on tablet?*
   - Yes, simply drag the node to another parent node.
2. *Is palm rejection supported on the Tablet app?*
...
3. *How do I clear the Tablet app cache?*
