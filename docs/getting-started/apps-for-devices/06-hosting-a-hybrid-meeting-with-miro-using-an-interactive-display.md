---
title: Hosting a hybrid meeting with Miro using an interactive display
...
- If you are working from an office, choose the right meeting space that will accommodate the in-person participants and has the right technology setup (fast wifi, interactive displays, video screens, cameras, high-quality microphones). [Check out our guide for choosing the right type of display to use with Miro for your meeting](09-selecting-the-right-interactive-display-for-hybrid-collaboration.md)
...
- For easier setup, it is recommended that participants pre-install the Miro [Mobile](08-mobile-app.md), [Tablet](11-tablet-app.md), or [Desktop](05-desktop-app.md) app on their personal devices. This will allow them to launch a Miro board easily during the meeting. Participants are not limited to a laptop and can use any device to access the Miro board during a meeting, whether it’s a mobile phone or tablet
- Test the meeting setup in advance to ensure the experience is optimal for all participants
...
- Share documentation (board links, specific frames, etc.) before, during, and after the meeting to make sure every participant has access to the same information
...
- If you are in a conference room with a display, make sure that the device is one of the following in order to launch Miro:
  ...
  - A Cisco Webex Board
  - If you are using a Cisco Webex Board, there are two ways you can set up the Miro app - [directly from Control Hub](14-using-miro-on-a-webex-board.md#adding-the-app-from-control-hub) or [within the UI Extensions editor](14-using-miro-on-a-webex-board.md#adding-the-app-within-the-ui-extensions-editor)
- Launch Miro by visiting [miro.com/login](https://miro.com/login) in the browser or install the Miro app from the[Microsoft App Store](https://www.microsoft.com/p/miro-online-collaborative-whiteboard-platform/9n236hqqtvnh?activetab=pivot:overviewtab) for all Windows 10-based devices (except Surface Hubs)
- If you are using a Surface Hub device, you can launch Miro in the latest Microsoft Edge browser (version 85 and above) by visiting [miro.com/login](https://miro.com/login)
- Once you launch Miro, log in using your credentials. You can also use our new [Quick sign-in feature](10-send-to-display.md) to log in faster
...
- Use digital meeting tools, such as Miro by default. Instead of brainstorming with sticky notes, [create them in Miro](../../using-miro/essential-tools/14-sticky-notes.md). Instead of taking handwritten meeting notes, record the outcomes of the session in Miro so everyone can have access to them asynchronously
...
- Start the meeting with an [ice breaker](https://miro.com/miroverse/ice-breakers/) to get the conversation started and get newbies familiarized with Miro
...
- Use Miro’s [dot voting](https://miro.com/templates/dot-voting/) feature to get everyone engaged during the conversation, either on their personal devices (mobile, tablet) or on the interactive display directly
- Use Miro’s Attention Management features, such as [bring everyone to me](../../using-miro/facilitation-tools/04-attention-management.md). If an in-person participant is explaining an idea on an interactive display, they can tap **bring everyone to me** to make sure that remote team members are seeing the right part of the board and are ready to collaborate and follow the discussion
