---
title: Selecting the right interactive display for hybrid collaboration
...
![Miro_on_an_interactive_display.jpg](images/21016057644178_Miro%20on%20an%20interactive%20display.jpg)
*Using Miro on an interactive display*

### What you should consider

- Before making the decision of what type of display to choose, you need to evaluate what your team needs are. Think about these questions:
...
- Then, you should consider the device capabilities that would be most suitable for your needs.
...
- For Windows-based devices like Dell, you can [download the latest Miro app here](https://desktop.miro.com/platforms/win32/Miro.exe) or from the Microsoft app Store.
- We also recommend using an active stylus or digital pen for drawing or writing on the screen.
- Read more about using Miro on [interactive displays](07-interactive-displays.md).
- Learn [how to conduct a hybrid meeting with Miro on an interactive display](06-hosting-a-hybrid-meeting-with-miro-using-an-interactive-display.md).
