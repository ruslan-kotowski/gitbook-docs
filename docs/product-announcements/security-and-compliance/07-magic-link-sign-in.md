...
- Lessened burden on users to remember complex passwords
- Eliminated reuse of passwords (users essentially get a new password each time)
- Reduced risk of credential stuffing and phishing attacks
- Single-use login link – link expires after use
