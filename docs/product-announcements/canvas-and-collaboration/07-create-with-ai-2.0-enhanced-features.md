---
title: 'Create with AI 2.0: Enhanced Features'
article_id: 26089362119442
sidebar_position: 9
...
When using Create with AI 2.0, users will benefit from guided workflows for different content types, improved prompt suggestions, and the ability to generate results from selected board context.
